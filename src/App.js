  ...
  render() {
    return (
      <div>
        <Router>
        <Navbar/>
        {/* <Searchbar query ="assam"/> */}
        <Routes>
        <Route exact path="/" element={<News key = "/" pageSize = {5} country = "in" category = ""/>}/>
        <Route exact path="/search" element={<Searchbar key = "/search" query ={this.state.query}/>}/>
